...
import type { AppMetadata, Address, Device, WalletInit, EIP1193Provider, WalletModule, Chain, TokenSymbol, ChainWithDecimalId, DeviceNotBrowser } from '@web3-onboard/common';
...
export type CustomNotification = Partial<Omit<Notification, 'startTime' | 'network' | 'id' | 'key'>>;
export type CustomNotificationUpdate = Partial<Omit<Notification, 'startTime' | 'network'>>;
...
export type Action = AddChainsAction | UpdateChainsAction | AddWalletAction | UpdateWalletAction | RemoveWalletAction | ResetStoreAction | UpdateAccountAction | UpdateAccountCenterAction | SetWalletModulesAction | SetLocaleAction | UpdateNotifyAction | AddNotificationAction | RemoveNotificationAction | UpdateAllWalletsAction | UpdateConnectModalAction | UpdateAppMetadataAction | UpdateWagmiConfigAction;
export type AddChainsAction = {
    type: 'add_chains';
    payload: Chain[];
};
export type UpdateChainsAction = {
    type: 'update_chains';
    payload: Chain;
};
